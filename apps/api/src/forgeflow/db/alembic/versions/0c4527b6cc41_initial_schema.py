...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_customers_shopify_domain"), "customers", ["shopify_domain"], unique=False
    )
    op.create_table(
        "policy_documents",
        ...
        sa.Column(
            "uploaded_at", sa.DateTime(timezone=True), server_default="now()", nullable=False
        ),
        sa.Column("id", sa.UUID(), server_default=sa.text("gen_random_uuid()"), nullable=False),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        op.f("ix_policy_documents_category"), "policy_documents", ["category"], unique=False
    )
    op.create_index(
        op.f("ix_policy_documents_content_hash"), "policy_documents", ["content_hash"], unique=False
    )
    op.create_index(
        op.f("ix_policy_documents_shopify_domain"),
        "policy_documents",
        ["shopify_domain"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_prompt_versions_prompt_name"), "prompt_versions", ["prompt_name"], unique=False
    )
    op.create_table(
        "orders",
