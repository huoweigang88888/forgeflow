...
class Ticket(Base, UUIDMixin, TimestampMixin, TenantMixin):
    ...
    # --- Customer Input ---
    platform: Mapped[str | None] = mapped_column(String(20), default="mock", doc="Platform: shopify | mock")
    ...
    extra_data: Mapped[dict | None] = mapped_column(JSONB, doc="Arbitrary extra state (order_info, logistics_status, etc.)")

    # --- Intent Detection ---
    intent: Mapped[str | None] = mapped_column(
        String(50),
        index=True,
        doc="shipping_delay | refund_request | wrong_item | damaged_item | exchange_request | other",
    )
    ...
    llm_cost_total: Mapped[float | None] = mapped_column(Float, doc="Total LLM cost for this ticket")
